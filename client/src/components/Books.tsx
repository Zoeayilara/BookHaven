...
type Book = {
  ...
  genre: string;
  image: string;
  /** Filename stem in attached_assets/, used to find optimized variants. */
  imageBase: string;
  description: string;
...
const books: Book[] = [
  {
    ...
    purchaseLinks: [
      ...
      { name: "Selar", url: "https://selar.com/b009d13935" },
  ...
  },
  {
    ...
    purchaseLinks: [
      ...
      { name: "Selar", url: "https://selar.com/mcu73310v3" },
      { name: "Contact Author", url: "#contact" }
    ]
  },
  {
    ...
    purchaseLinks: [
      ...
      { name: "Selar", url: "https://selar.com/m9u3118w33" },
      { name: "Contact Author", url: "#contact" }
    ]
  },
  {
  ...
  },
  {
    ...
    purchaseLinks: [
      ...
      { name: "Selar", url: "https://selar.com/8r387b9780" },
      { name: "Contact Author", url: "#contact" }
    ]
  },
  {
    ...
    purchaseLinks: [
      ...
      { name: "Selar", url: "https://selar.com/5458075971" },
      { name: "Contact Author", url: "#contact" }
    ]
  },
  {
    ...
    purchaseLinks: [
      ...
      { name: "Selar", url: "https://selar.com/7384003649" },
      { name: "Contact Author", url: "#contact" }
    ]
  },
  {
    ...
    purchaseLinks: [
      ...
      { name: "Selar", url: "https://selar.com/o4jb1j095w" },
      { name: "Contact Author", url: "#contact" }
    ]
  },
  {
    ...
    purchaseLinks: [
      ...
      { name: "Selar", url: "https://selar.com/93t7f1f360" },
      { name: "Contact Author", url: "#contact" }
    ]
  },
  {
...
export default function Books() {
  ...
  // threshold stays 0 on purpose. These wrappers can be taller than a phone
  // screen (the one-column books grid is ~9200px), and a fractional threshold
  // on an element taller than the viewport can never be satisfied, so the whole
  // section used to sit at opacity-0 forever on mobile.
              ...
              <div className="space-y-6 mt-4">
                <div className="flex flex-col sm:flex-row gap-4">
                  <div className="w-full sm:w-48 flex-shrink-0">
                    <ResponsiveImage
                      base={selectedBook.imageBase}
                      fallback={selectedBook.image}
